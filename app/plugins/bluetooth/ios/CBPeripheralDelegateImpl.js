...
var CBPeripheralDelegateImpl = (function (_super) {
    ...
    CBPeripheralDelegateImpl.prototype.peripheralDidReadRSSIError = function (peripheral, RSSI, error) {
        common_1.CLog(common_1.CLogTypes.info, "CBPeripheralDelegateImpl.peripheralDidReadRSSIError ---- peripheral: " + peripheral + ", rssi: " + RSSI + ", error: " + error);
    };
    ...
    CBPeripheralDelegateImpl.prototype._getProperties = function (characteristic) {
        ...
        return {
            ...
            write: (props & 8) ===
                8,
            writeWithoutResponse: (props & 4) ===
                4,
            notify: (props & 16) ===
                16,
            indicate: (props & 32) ===
                32,
            authenticatedSignedWrites: (props &
                64) ===
                64,
            extendedProperties: (props & 128) ===
                128,
            notifyEncryptionRequired: (props &
                256) ===
                256,
            indicateEncryptionRequired: (props &
                512) ===
                512
        };
    };
